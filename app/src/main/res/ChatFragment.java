...
public class ChatFragment extends Fragment {
    ...
    private String getFeatureCardText(int cardIndex) {
        String[][] featureTexts = {
            ...
            {"“ལོ་ལྔའི་འཆར་འགོད་བཅོ་ལྔ་བར་”སློབ་སྦྱོང་བྱས་པའི་མྱོང་ཚོར་ཞིག་བྲིས་རོགས།", "དགེ་རྒན་ལ་བསྟོད་པའི་སྙན་ངག་ཅིག་བྲིས་རོགས།", "སློབ་གཙོ་ལ་སློབ་ཐོན་མཛད་སྒོའི་ཐོག་གི་གཏམ་བཤད་ཅིག་བྲིས་རོགས།", "གསོ་བ་རིག་པ་བསླབ་པའི་དགོས་པ་ཅི་ཡིན།"},
